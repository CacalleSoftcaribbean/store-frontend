    ...
    <div>
        <div class="p-4">
            <form class="shadow p-3" @submit.prevent="insert">
                <h2 class="text-center text-2xl font-bold mb-6">Nuevo Rol</h2>
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Estado</label>
                    <select v-model="rol.status" required=""
                ...
                <div class="mb-6">
                    ...
                    <textarea type="text" v-model="rol.description"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        insert() {
            ...
            fetch(url, {
                ...
                .then((data) => {
                    swal(data.message)
                        .then(() => {
                            window.location.assign("/adminroles")
                        });
                });
        },
    }
